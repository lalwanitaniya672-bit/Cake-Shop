    ...
    <footer className="bg-chocolate text-white/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:hidden py-10">
          ...
          <div className="flex gap-3 mb-6">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-gold/30 flex items-center justify-center transition-all duration-300"
                aria-label={social.label}
              >
                <span className="text-white/70"><social.icon /></span>
              </a>
            ))}
          </div>
          ...
          {/* Explore + Company Side by Side */}
          <div className="grid grid-cols-2 gap-8 py-6">
            <div>
              <h4 className="font-display text-white text-xs font-semibold uppercase tracking-wider mb-3">
                Explore
              </h4>
          ...
          <div className="py-6">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+918767438990" className="text-sm text-white/60 hover:text-gold transition-colors">+91 8767438990</a>
              </li>
              <li className="flex items-center gap-3">
          ...
          <div className="pt-5 text-center">
            <p className="text-xs text-white/40">
              &copy; {new Date().getFullYear()} The Velvet Crumb. All rights reserved.
            </p>
          </div>
        </div>

        {/* ===== DESKTOP FOOTER (unchanged) ===== */}
        <div className="hidden md:block py-10 sm:py-16">
          <div className="grid grid-cols-2 lg:grid-cols-12 gap-8 sm:gap-12">
            {/* Brand */}
