  ...
  return (
    <div className="min-h-screen bg-cream flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=800&h=1200&fit=crop&q=80')] bg-cover bg-center opacity-30" />
        <div className="relative z-10 flex items-center justify-center p-16">
          <div className="text-center text-white">
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-rose to-gold flex items-center justify-center mx-auto mb-8">
            ...
            <p className="text-white/60 max-w-sm">
              Sign in to access your orders, saved designs, and exclusive member benefits.
            </p>
          </div>
        </div>
      </div>
        ...
        >
          <Link to="/" className="lg:hidden inline-flex items-center gap-2 mb-8">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-rose to-gold flex items-center justify-center">
              <span className="font-display text-white font-bold text-sm">V</span>
            </div>
            <span className="font-display text-lg font-semibold text-chocolate">The Velvet Crumb</span>
          </Link>

          <h1 className="font-display text-3xl font-bold text-chocolate mb-2">Sign In</h1>
          ...
          {error && (
            <motion.div
              ...
              className="bg-red-50 border border-red-200 text-red-700 text-sm rounded-xl p-4 mb-6"
            >
              {error}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 rounded-xl border border-cream-dark bg-white text-sm text-charcoal focus:outline-none focus:ring-2 focus:ring-gold/30 focus:border-gold transition-all"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 text-sm text-charcoal/70">
                <input type="checkbox" className="w-4 h-4 rounded border-cream-dark text-gold focus:ring-gold/30" />
                Remember me
              </label>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-chocolate text-white py-3.5 rounded-full text-sm font-semibold hover:bg-chocolate-light transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center">
              <span className="bg-cream px-4 text-xs text-warm-gray">or continue with</span>
            </div>
          </div>
