  ...
  return (
    <div className="min-h-screen bg-cream flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?w=800&h=1200&fit=crop&q=80')] bg-cover bg-center opacity-30" />
        <div className="relative z-10 flex items-center justify-center p-16">
          <div className="text-center text-white">
            ...
            <h2 className="font-display text-4xl font-bold mb-4">Join Our Family</h2>
            <p className="text-white/60 max-w-sm">
              Create an account to track orders, save favorite designs, and get exclusive member offers.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 sm:p-12">
        ...
        >
          ...
          <h1 className="font-display text-3xl font-bold text-chocolate mb-2">Create Account</h1>
          <p className="text-warm-gray mb-8">
